  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
      <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
        <a href={"/"} className="flex title-font font-medium items-center md:justify-start justify-center text-white">
          ...
          <span className="ml-3 text-xl">E-store.com</span>
        </a>
    ...
    <div className="bg-gray-800 bg-opacity-75">
      <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
        <p className="text-gray-400 text-sm text-center sm:text-left">© 2022 E-store.com —
          <a href="https://www.linkedin.com/in/rohit-rawat-a41b411a9/" rel="noopener noreferrer" className="text-gray-500 ml-1" target="_blank">@rohitrawat</a>
        </p>
