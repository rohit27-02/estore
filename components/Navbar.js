...
const Navbar = ({cart,addToCart,removeFromCart,clearCart,subTotal}) => {
    ...
    return (
        ...
        <div className='sticky top-0 z-10 bg-white  flex justify-center items-center flex-col md:flex-row md:justify-start py-2 shadow-md'>
            ...
            <div  className="absolute right-14 md:mr-4 top-4 cursor-pointer">
                <a href={'/Login'}><MdAccountCircle className='hover:text-pink-500 text-xl md:text-3xl' /></a>
            </div>
            <div onClick={toggleCart} className="cart absolute right-0 mx-5 top-4 cursor-pointer">
                <AiOutlineShoppingCart className='hover:text-pink-500 text-xl md:text-3xl' />
            </div>
            <div ref={ref} className="sidebar fixed right-0 top-0 bg-pink-200 p-10 transform transition-transform translate-x-full z-10 shadow-xl overflow-y-scroll h-full">
               ...
               <ol  className='list-decimal font-semibold mx-1 my-3'>
                ...
                <a href={"/Checkout"}><button className="flex text-white bg-pink-500 border-0 py-2 px-4 my-7 mr-3 focus:outline-none hover:bg-pink-600 rounded text-lg"><BsFillBagCheckFill className='my-auto mr-1'/>Check out</button></a>
