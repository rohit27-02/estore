  ...
  return (
    <div >
      <Head>
        ...
        <meta name="description" content="E-store shop like a local" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
     <div>
       <img src="/main3.jpg" alt="logo" />
     </div>
     <section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-meWhatever cdium title-font mb-2 text-gray-900">Shop like a local at home</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Now, why to go market when you can shop at best prices from your home !!</p>
    </div>
